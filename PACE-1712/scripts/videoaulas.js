        ...
        const aulas = [
            {
                ...
                videoId: "IofGLtMVSjM", // ID do vídeo do YouTube
            },
            {
                ...
                videoId: "4Azrf7kaLwA", // ID de outro vídeo
            },
            {
                ...
                videoId: "zbO24oLkK3g", // ID de mais um vídeo
            },
            {
                ...
                videoId: "BCOsk_r_vEw", // ID de mais um vídeo
            }
        ];
        ...
        // Adicionando o evento de clique no botão "Próxima Aula"
        document.getElementById('botaoProx').addEventListener('click', (event) => {
            event.preventDefault(); // Previne o comportamento padrão do link
            atualizarAula(); // Atualiza o conteúdo da aula
        });

        // Atualiza o link do botão de Exercícios
    function atualizarLinkExercicios() {
    const linkExercicios = document.getElementById('linkExercicios');
    linkExercicios.href = `exercicios.html?aula=${aulaAtual}`; // Passa o índice da aula como parâmetro na URL
}

// Chama a função para atualizar o link sempre que a aula for alterada
